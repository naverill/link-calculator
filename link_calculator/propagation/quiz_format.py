...
def test_free_space_loss(sat_lat: float, sat_long: float, gs_lat: float, gs_long: float, frequency: float, orbit_radius: float):
    gamma = angle_sat_to_ground_station(
        gs_lat,
        gs_long,
        sat_lat,
        sat_long
